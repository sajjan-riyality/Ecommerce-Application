            ...
            <div data-simplebar>
                ...
                <ul class="side-nav">
                    ...
                    <li class="side-nav-item">
                        <a href="Dashbord" class="side-nav-link">
                            <span class="menu-icon"><i class="ti ti-message"></i></span>
                  ...
                  <li class="side-nav-item">
                        <a href="regiostrationForm" class="side-nav-link">
                   ...
                   <li class="side-nav-item">
                        <a href="updateForm" class="side-nav-link">
                            <span class="menu-icon"><i class="ti ti-calendar"></i></span>
                            <span class="menu-text"> update user</span>
                        </a>
                    </li>
                      <li class="side-nav-item">
                        <a href="viewAll" class="side-nav-link">
                            <span class="menu-icon"><i class="ti ti-calendar"></i></span>
                     ...
                     <li class="side-nav-item">
                        <a href="userDashbord" class="side-nav-link">
                            ...
                            <span class="menu-text"> userDashbord </span>
                        </a>
                    </li>
