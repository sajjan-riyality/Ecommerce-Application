                        ...
                        <div class="card">
                            <div class="card-header border-bottom border-light">
                                <div class="d-flex flex-wrap justify-content-between gap-2">
                                    ...
                                    <div>
                                        <a href="apps-ecommerce-products-add.html" class="btn btn-primary"><i class="ti ti-plus me-1"></i>Add Products</a>
                                    </div>
                                </div>
                            </div>
    ...
    <tbody>
            ...
            <tr>
              ...
              <%--   <td>${product.stock}</td> --%>
                ...
                <td>
                    <span class="badge ${product.status == 'Active' ? 'bg-success-subtle text-success' : 'bg-danger-subtle text-danger'} fs-12 p-1">
                        ${product.status}
                    </span>
                </td>
                <td class="pe-3">
                    <div class="hstack gap-1 justify-content-end">
                        <a href="/product/view/${product.id}" class="btn btn-soft-primary btn-icon btn-sm rounded-circle"> 
                            <i class="ti ti-eye"></i>
                        </a>
                        <a href="/product/edit/${product.id}" class="btn btn-soft-success btn-icon btn-sm rounded-circle"> 
                            <i class="ti ti-edit fs-16"></i>
                        </a>
                        <a href="/product/delete/${product.id}" class="btn btn-soft-danger btn-icon btn-sm rounded-circle"> 
